...
export const Route = createFileRoute('/anmelden')({ component: LoginPage })
    ...
    <div className="min-h-screen flex items-center justify-center px-6 py-12 bg-gray-50">
      <div className="w-full max-w-md">
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="flex items-center justify-between">
              ...
              <Link to="/passwort-vergessen" className="text-sm text-orange-600 hover:text-orange-700">
        ...
        <p className="text-center text-gray-600 mt-6">
          ...
          <Link to="/registrieren" className="text-orange-600 hover:text-orange-700 font-medium">
            {t('auth.register')}
          </Link>
        </p>
      </div>
